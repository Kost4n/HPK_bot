...
@Component
class BuyFirsyearHandler : CallbackHandler {
    override val name: HandlerName = HandlerName.FIRSTYEAR_WORKS
    ...
    override fun processCallbackData(
        ...
        if (arguments.first() == "back") {
            ...
            val data = WorksServiceImpl().getFirstyearNameWorks()
            val callback = HandlerName.BUY_FIRSTYEAR_START_PAY.text
            for (record in data) {
