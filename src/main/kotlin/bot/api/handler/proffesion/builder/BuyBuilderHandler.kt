...
@Component
class BuyBuilderHandler : CallbackHandler {
    override val name: HandlerName = HandlerName.BUILDER_WORKS
    ...
    override fun processCallbackData(
        ...
        if (arguments.first() == "back") {
            ...
            val data = WorksServiceImpl().getBuilderNameWorks()
            val callback = HandlerName.BUY_BUILDER_START_PAY.text
            for (record in data) {
