package bot.api.handler.proffesion.lawyer
...
@Component
class BuyLawyerHandler : CallbackHandler {
    override val name: HandlerName = HandlerName.LAWYER_WORKS
    ...
    override fun processCallbackData(
        ...
        if (arguments.first() == "back") {
            ...
            val data = WorksServiceImpl().getLawyerNameWorks()
            val callback = HandlerName.BUY_LAWYER_START_PAY.text
            for (record in data) {
